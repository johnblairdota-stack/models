...
// 💡 The five-light per-space rig, now its own module. It was exported from HERE, which put all
// 4,900 lines of the retired survival mode on the party mode's critical path — see its header.
