 ...
 *
 *   node harness/_skin1-geom.mjs                     both arms, every check
 *   node harness/_skin1-geom.mjs --cell 0.12         a different erosion grain
 *   node harness/_skin1-geom.mjs --report            + the per-mesh triangle cost table
 *
 * ---------------------------------------------------------------------------------------------
