 ...
 *
 *   node harness/_skin1-golden-split.mjs            the split, per arm, per mesh
 *   node harness/_skin1-golden-split.mjs --rows     + every moved mesh row
 *
 * ---------------------------------------------------------------------------------------------
...
const GOLD = fileURLToPath(new URL('./_ap3-golden.json', import.meta.url));
