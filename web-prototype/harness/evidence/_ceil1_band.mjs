 ...
 *
 *   node harness/evidence/_ceil1_band.mjs progress/light1-ceilA-*.png
 *   node harness/evidence/_ceil1_band.mjs --band 0.22 --json a.png b.png
 *
...
if (!files.length) {
  console.error('usage: node harness/evidence/_ceil1_band.mjs [--band 0.20] [--json] <png...>');
  process.exit(2);
}
