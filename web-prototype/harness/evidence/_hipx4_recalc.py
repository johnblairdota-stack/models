...
THE ONE THING THE "SHADING NORMALS" ELIMINATION NEVER TESTED.
    ...
    "C:\\Program Files\\Blender Foundation\\Blender 4.5\\4.5\\python\\bin\\python.exe" ^
      harness/evidence/_hipx4_recalc.py <in.glb> <out.glb> [--smooth DEG] [--control-passthrough]
...
def main():
    args = sys.argv[1:]
    if len(args) < 2:
        raise SystemExit("usage: python harness/evidence/_hipx4_recalc.py <in.glb> <out.glb> "
