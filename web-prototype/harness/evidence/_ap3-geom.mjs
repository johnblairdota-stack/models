 ...
 *
 *   node harness/evidence/_ap3-geom.mjs                 the tree as it is
 *   node harness/evidence/_ap3-geom.mjs --preview       …with `docs/slices/task-aperture-3.md`'s edits
 *   node harness/evidence/_ap3-geom.mjs --spans         print every offending box
 *
 * ---------------------------------------------------------------------------------------------
...
if (process.argv[1]?.replace(/\\/g, '/').endsWith('harness/evidence/_ap3-geom.mjs')) {
