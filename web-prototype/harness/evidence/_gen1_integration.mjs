 ...
 *
 *   node harness/evidence/_gen1_integration.mjs [--seed 5] [--seeds 4,5,6]
 *
...
// finish, so `settle()` waits for ever. `harness/evidence/_lineup_shot.mjs` documents the same trap.
