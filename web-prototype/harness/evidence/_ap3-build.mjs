 ...
 *
 *   node harness/evidence/_ap3-build.mjs --arm wired          one JSON census on stdout, sentinel-prefixed
 *   node harness/evidence/_ap3-build.mjs --arm default --pretty
 *
 * ---------------------------------------------------------------------------------------------
...
if (process.argv[1]?.replace(/\\/g, '/').endsWith('harness/evidence/_ap3-build.mjs')) {
