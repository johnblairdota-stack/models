 ...
 *
 *   node harness/evidence/_fd3_earshot.mjs            report the view's lighting state only
 *   node harness/evidence/_fd3_earshot.mjs --shoot    write the four matched-angle head crops
 *
