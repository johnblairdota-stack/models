 ...
 *
 *   node harness/_loc1_golden.mjs --write <file>    record the module's whole surface
 *   node harness/_loc1_golden.mjs --check <file>    compare it, leaf by leaf, with Object.is
 *
