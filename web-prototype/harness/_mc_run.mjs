 ...
 *   node harness/_mc_run.mjs solo     the shipped solo director, per wing, no hunter
 *   node harness/_mc_run.mjs detent   fixed detent per wing, no hunter
 *   node harness/_mc_run.mjs hunter   full expedition with the hunter, seeds x policies
 */
