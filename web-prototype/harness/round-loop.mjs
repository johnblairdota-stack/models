 ...
 *
 *   **It fits.** `rrr-social-round.md` §1 budgets 26:25 / 31:50 / 37:25 for 4/5/6 episodes, and
...
// ---------------------------------------------------------------- R2 · the session budget
{
  ...
  t('R2 · 4/5/6 episodes land on the budgeted 26:25 / 31:50 / 37:25',
    Math.abs(sessionSeconds(4) - 1585) < 1 && Math.abs(sessionSeconds(5) - 1910) < 1 && Math.abs(sessionSeconds(6) - 2245) < 1,
