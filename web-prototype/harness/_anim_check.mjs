 ...
 *
 *   node harness/_anim_check.mjs [--clip friendly] [--anims Walking,Running,Attack]
 *   node harness/_anim_check.mjs --clip n30 --anims Walking --control-bind
 *
 ...
 *
 * ⚠️ GPU ARGS AND `capture=1` ARE BOTH REQUIRED — see `harness/_lineup_shot.mjs` for what happens
